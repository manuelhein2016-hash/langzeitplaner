...
//
//   > `route(ctx, req)` … SHARED by api/v1/index.js and by tests/helpers/loopback.js, so
...
export function createRelay(opts = {}) {
   ...
   * the exact bytes it signed; this turns them into a `ServerReq` the way `api/v1/index.js`
